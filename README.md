# hangman_solver
## Idea
Everybody knows the game [hangman](https://de.wikipedia.org/wiki/Galgenm%C3%A4nnchen) (=Galgenmännchen). Given the length of a word the user is thinking of, this solver proposes the best letter-guess.
